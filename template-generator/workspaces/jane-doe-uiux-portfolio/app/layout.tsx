...
export const metadata: Metadata = {
  title: `${heroSection?.name || 'Your Name'} - Software Developer`,
  description: heroSection?.description || 'Professional software developer portfolio showcasing web development, mobile apps, and software engineering projects.',
  keywords: ['software developer', 'web development', 'portfolio', 'react', 'typescript', 'full-stack'],
  authors: [{ name: heroSection?.name || 'Your Name' }],
  creator: heroSection?.name || 'Your Name',
  openGraph: {
    title: `${heroSection?.name || 'Your Name'} - Software Developer`,
    description: heroSection?.description || 'Professional software developer portfolio showcasing web development, mobile apps, and software engineering projects.',
    type: 'website',
